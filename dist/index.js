'use strict';var react=require('react');var v=p=>{let{theme:c,animation:s,meshColors:e,backgroundAnimation:n,textAnimation:d,mode:m="auto"}=p,t=c?.light||{background:"#ffffff",color:"#000000"},r=c?.dark||{background:"#000000",color:"#ffffff"},a="",l="";if(m==="light"?l=`
...
</script>`.replace(/>\s+</g,"><").trim();return c.replace("<body>",`<body>${H}`)}}}exports.useSplashScreen=O;exports.viteSplashScreen=B;